...
export default function TextInput() {
  ...
  return (
    <div className="group flex items-center gap-2 h-9 px-3 bg-muted/30 border border-border rounded-full hover:border-primary/40 focus-within:border-primary/60 focus-within:ring-2 focus-within:ring-primary/20 focus-within:bg-background transition-all">
